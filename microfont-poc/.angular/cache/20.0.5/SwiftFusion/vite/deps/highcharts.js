...
var require_highcharts = __commonJS({
 ...
 - ${i11}: ${e11}`, r10 && (a10 += encodeURI(i11) + "=" + encodeURI(e11));
      ...
      class i6 extends eJ {
        ...
        constructor(t10, e10) {
          super(t10, e10), i6.useForeignObject ? this.foreignObject = t10.createElement("foreignObject").attr({ zIndex: 2 }) : this.css(__spreadValues({ position: "absolute" }, t10.styledMode ? {} : { fontFamily: t10.style.fontFamily, fontSize: t10.style.fontSize })), this.element.style.whiteSpace = "nowrap";
        }
