...
public class RegisterClient {
    ...
    public AddressContactDto getAddressContact() {
        return addressContact;
    }

    public void setAddressContact(AddressContactDto addressContact) {
    ...
    public static class AddressContactDto {
        ...
        public void setAddressType(Object addressType) {
            this.addressType = normalize(addressType);
        }
        ...
        public void setDivision(Object division) {
            this.division = normalize(division);
        }
